...
namespace FaceRecognitionDataAccess.UserClass
{
    public class Encryption
    {
        ...
        {
            //clearText = ConvertToBase64String(clearText);
        ...
        public static string ConvertToBase64String(string InputStr)
        {
        ...
        public static string ConvertFromBase64String(string InputStr)
        {
            byte[] b = Convert.FromBase64String(InputStr);
    ...
    {
        internal const string passPhrase = "PoMSPas@5pr@seTP"; // can be any string
