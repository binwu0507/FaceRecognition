...
namespace FaceRecognitionDotNet
{
    public sealed class FaceRecognition : DisposableObject
    {
        ...
        public IEnumerable<IDictionary<FacePart, IEnumerable<DlibDotNet.Point>>> FaceLandmark(Image faceImage, IEnumerable<Location> faceLocations = null, PredictorModel model = PredictorModel.Large)
        {
            if (faceImage == null)
